...
const Home = () => {
  return (
    <div className="min-h-screen flex-[3] transition-all duration-500 dark:bg-dark bg-light dark:text-light text-dark font-light">
      {/* Profile Section */}
      <div className="flex flex-col items-center justify-center gap-5 relative mt-20 mr-20 max-w-3xl">
        ...
        <div className="space-y-2 text-center">
          <h1 className="text-6xl font-extralight tracking-wide text-accent">
            {/* Increased font size for the name */}
            Cledenir <span className="font-medium">Souza</span>
          </h1>
          <h3 className="text-3xl font-extralight tracking-wider text-light dark:text-light">
            Data Analyst
          </h3>
        </div>
      </div>
    ...
    <div className="relative max-w-3xl mt-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
        ...
        <div className="relative pl-8">
          <div className="absolute left-[4px] top-[8px] h-3 w-3 rounded-full bg-black dark:bg-white"></div>
          <div className="space-y-1">
            <h3 className="font-Light tracking-wide text-base">Defining Cloud Computing for Decision-makers: Cloud Business Model</h3>
