...
const Home = () => {
  return (
    <div className="min-h-screen flex-[3] transition-all duration-500 bg-[#151a1e] text-[#d8dcde] font-light">
      {/* Profile Section */}
      <div className="flex flex-col items-center justify-center gap-5 relative mt-20 mr-20 max-w-3xl">
        ...
        <div className="space-y-2 text-center">
          ...
          <h3 className="text-3xl font-extralight tracking-wider text-[#d8dcde]">
            Data Analyst
          </h3>
        </div>
      </div>
      ...
      <main className="flex max-w-[1000px] flex-col gap-10 p-5 md:py-14 mr-20">
        <div className="space-y-5">
          <h2 className="text-xl font-medium tracking-wide md:text-2xl text-[#d8dcde]">
            About Me
          </h2>
          <p className="text-sm text-[#d8dcde] md:text-base max-w-3xl font-light leading-relaxed">
        ...
        <div className="space-y-1">
          <h2 className="text-xl font-medium tracking-wide md:text-2xl text-[#d8dcde]">Job Experience</h2>
          <div className="flex flex-col lg:flex-row lg:gap-20 max-w-3xl">
            {/* Job experience content goes here */}
          </div>
        </div>

        {/* Job Experience Section */}
        <div className="flex flex-col items-start justify-start gap-5 border-b border-[#182e3b] p-5 max-w-3xl">
            <ul className="relative">
              {/* Vertical Line */}
              <div className="absolute left-[9px] top-0 h-full w-[1px] bg-[#182e3b]"></div>
              ...
              <li className="relative flex flex-col gap-1 pl-8">
                ...
                ></div>
                 <div className="flex justify-between items-center w-full gap-32">
                  <span className="font-medium tracking-wide md:text-lg text-[#d8dcde]">CUSTOMER SUPPORT ANALYST</span>
                  <span className="text-sm text-[#d8dcde] font-light">2024 - Current</span>
                </div>
                <span className="font-light tracking-wide mb-4 text-[#d8dcde]">Entain Group ¦ Lisbon</span>
                <p className="text-sm text-[#d8dcde] md:text-base font-light leading-relaxed">
              ...
              <li className="relative flex flex-col gap-1 pl-8 mt-6">
                ...
                ></div>
                <div className="flex justify-between items-center w-full gap-32">
                  <span className="font-medium tracking-wide md:text-lg text-[#d8dcde]">CONTENT MODERATION SPECIALIST</span>
                  <span className="text-sm text-[#d8dcde] font-light">2023 - 2024</span>
                </div>
                <span className="font-light tracking-wide mb-4 text-[#d8dcde]">Accenture ¦ Lisbon</span>
                <p className="text-sm text-[#d8dcde] md:text-base font-light leading-relaxed">
              ...
              <li className="relative flex flex-col gap-1 pl-8 mt-6">
                ...
                ></div>
                 <div className="flex justify-between items-center w-full gap-32">
                  <span className="font-medium tracking-wide md:text-lg text-[#d8dcde]">DESKTOP SUPPORT TECHNICIAN</span>
                  <span className="text-sm text-[#d8dcde] font-light">2014 - 2017</span>
                </div>
                <span className="font-light tracking-wide mb-4 text-[#d8dcde]">Wisdom Hardware ¦ São Paulo</span>
                <p className="text-sm text-[#d8dcde] md:text-base font-light leading-relaxed">
              ...
              <li className="relative flex flex-col gap-1 pl-8 mt-6">
                ...
                ></div>
                <div className="flex justify-between items-center w-full gap-32">
                  <span className="font-medium tracking-wide md:text-lg text-[#d8dcde]">IT SUPPORT SPECIALIST</span>
                  <span className="text-sm text-[#d8dcde] font-light">2005 - 2011</span>
                </div>
                <span className="font-light tracking-wide mb-4 text-[#d8dcde]">Souza Cruz ¦ São Paulo</span>
                <p className="text-sm text-[#d8dcde] md:text-base font-light leading-relaxed">
      ...
      <div className="flex max-w-[1000px] flex-col gap-3 px-10 -mt-5 mr-20">
        <div className="space-y-10">
          <h2 className="text-xl font-Light tracking-wide md:text-2xl text-[#d8dcde]">Courses & Certifications</h2>
          <div className="relative max-w-3xl mt-6">
            {/* Left vertical line */}
            <div className="absolute left-[9px] top-[1px] h-[calc(100%-8px)] w-[1px] bg-[#182e3b]"></div>
            
            {/* Right vertical line */}
            <div className="absolute md:left-[calc(50%+25px)] left-[9px] top-[1px] h-[calc(100%-8px)] w-[1px] bg-[#182e3b]"></div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
              {/* Course 1 */}
              <div className="relative pl-8">
                <div
                  className="absolute left-[-12px] top-[-8px] h-3 w-3 rounded-full 
                  bg-[#2b88c6]"
                ></div>
                <h3 className="font-medium text-[#d8dcde]">Ironhack Data Analytics Bootcamp</h3>
                <span className="text-sm text-[#d8dcde] font-light">Aug 2024 - Nov 2024</span>
                <p className="text-sm text-[#d8dcde] md:text-base font-light leading-relaxed">
                  An immersive bootcamp focused on data analysis tools and techniques. Covered key topics like data visualization, SQL, Python, and statistical analysis.
                </p>
              </div>
              ...
              <div className="relative pl-8">
                <div
                  ...
                  bg-[#2b88c6]"
                ></div>
                <h3 className="font-medium text-[#d8dcde]">SQL for Data Science - Coursera</h3>
                <span className="text-sm text-[#d8dcde] font-light">Apr 2024</span>
                <p className="text-sm text-[#d8dcde] md:text-base font-light leading-relaxed">
                  Completed a course in SQL focused on data querying and manipulation using relational databases.
                </p>
              </div>
            </div>
          </div>
