...
const Home = () => {
  return (
    <div className="min-h-screen flex-[3] transition-all duration-500 dark:bg-black dark:text-white font-light">
      {/* Profile Section */}
      <div className="flex flex-col items-center justify-center gap-5 relative mt-20 mr-20 max-w-3xl">
        ...
        <div className="space-y-2 text-center">
          ...
          <h3 className="text-3xl font-extralight tracking-wider">Data Analyst</h3>
        </div>
      </div>
